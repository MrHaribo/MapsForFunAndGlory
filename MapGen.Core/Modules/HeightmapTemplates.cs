    ...
    public static class HeightmapTemplates
    {
        ...
        public static string GetRecipe(HeightmapTemplate template)
        {
            return template switch
            {
                ...
                HeightmapTemplate.Atoll => Atoll,
                HeightmapTemplate.Mediterranean => Mediterranean,
                HeightmapTemplate.Peninsula => Peninsula,
                HeightmapTemplate.Pangea => Pangea,
                HeightmapTemplate.Isthmus => Isthmus,
                HeightmapTemplate.Shattered => Shattered,
                HeightmapTemplate.Taklamakan => Taklamakan,
                HeightmapTemplate.OldWorld => OldWorld,
                HeightmapTemplate.Fractious => Fractious,
                HeightmapTemplate.Test => Test,
